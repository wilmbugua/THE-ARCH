# Simple HttpClient-based proxy and static server (port 8001)
$root = 'D:\KALCPOS\frontend'
$backend = 'http://127.0.0.1:8081'
$logFile = Join-Path $root 'proxy_requests_8001.log'
...
$listener.Start()
Write-Output "Serving $root on http://127.0.0.1:8001/ (proxying /api and /ws to $backend). Logging to $logFile"
